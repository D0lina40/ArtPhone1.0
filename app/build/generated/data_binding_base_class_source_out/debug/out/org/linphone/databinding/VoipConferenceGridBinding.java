...
public abstract class VoipConferenceGridBinding extends ViewDataBinding {
  @NonNull
  ...
  @NonNull
  public final GridBoxLayout gridBoxLayout;
  ...
  protected VoipConferenceGridBinding(Object _bindingComponent, View _root, int _localFieldCount,
      Chronometer activeConferenceTimer, ConstraintLayout conferenceConstraintLayout,
      GridBoxLayout gridBoxLayout, Group group, Guideline hingeBottom, Guideline hingeTop,
      TextView remoteName, VoipRemoteRecordingBinding remoteRecording,
  ...
  @NonNull
  public static VoipConferenceGridBinding inflate(@NonNull LayoutInflater inflater,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.voip_conference_grid, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static VoipConferenceGridBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<VoipConferenceGridBinding>inflateInternal(inflater, R.layout.voip_conference_grid, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.voip_conference_grid, null, false, component)
   */
  @NonNull
  @Deprecated
  public static VoipConferenceGridBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<VoipConferenceGridBinding>inflateInternal(inflater, R.layout.voip_conference_grid, null, false, component);
  }

  public static VoipConferenceGridBinding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static VoipConferenceGridBinding bind(@NonNull View view, @Nullable Object component) {
    return (VoipConferenceGridBinding)bind(component, view, R.layout.voip_conference_grid);
  }
}
