...
public class DialerFragmentBindingImpl extends DialerFragmentBinding implements org.linphone.generated.callback.OnClickListener.Listener, org.linphone.generated.callback.OnLongClickListener.Listener, org.linphone.generated.callback.BeforeTextChanged.Listener, org.linphone.generated.callback.AfterTextChanged.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.address_bar, 9);
        sViewsWithIds.put(R.id.controls, 10);
    }
    // views
    @NonNull
    private final android.widget.RelativeLayout mboundView0;
    @Nullable
    private final org.linphone.databinding.NumpadBinding mboundView01;
    @NonNull
    ...
    @Nullable
    private final android.view.View.OnLongClickListener mCallback206;
    @Nullable
    private final android.view.View.OnClickListener mCallback210;
    @Nullable
    private final androidx.databinding.adapters.TextViewBindingAdapter.BeforeTextChanged mCallback207;
    @Nullable
    private final androidx.databinding.adapters.TextViewBindingAdapter.AfterTextChanged mCallback208;
    // values
    // listeners
    ...
    public DialerFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }
    private DialerFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.mboundView01 = (org.linphone.databinding.NumpadBinding) bindings[8];
        ...
        setRootTag(root);
        // listeners
        mCallback205 = new org.linphone.generated.callback.OnClickListener(this, 1);
        mCallback209 = new org.linphone.generated.callback.OnClickListener(this, 5);
        mCallback206 = new org.linphone.generated.callback.OnLongClickListener(this, 2);
        mCallback210 = new org.linphone.generated.callback.OnClickListener(this, 6);
        mCallback207 = new org.linphone.generated.callback.BeforeTextChanged(this, 3);
        mCallback208 = new org.linphone.generated.callback.AfterTextChanged(this, 4);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x400L) != 0) {
            ...
            this.erase.setOnClickListener(mCallback205);
            this.erase.setOnLongClickListener(mCallback206);
            this.mboundView5.setOnClickListener(mCallback209);
            this.mboundView6.setOnClickListener(mCallback210);
            androidx.databinding.adapters.TextViewBindingAdapter.setTextWatcher(this.sipUriInput, mCallback207, (androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged)null, mCallback208, sipUriInputandroidTextAttrChanged);
        }
        if ((dirtyFlags & 0x600L) != 0) {
            // api target 1

            this.mboundView01.setKeyListener(viewModelOnKeyClick);
        }
        if ((dirtyFlags & 0x480L) != 0) {
            // api target 1
