...
public class TabsFragmentBindingImpl extends TabsFragmentBinding  {
    ...
    public TabsFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }
    private TabsFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x1840L) != 0) {
            ...
            org.linphone.utils.DataBindingUtilsKt.setLayoutConstraintGuidePercent(this.guidelineLeft, androidxDatabindingViewDataBindingSafeUnboxViewModelLeftAnchorGetValue);
        }
        if ((dirtyFlags & 0x1802L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x1820L) != 0) {
            ...
            org.linphone.utils.DataBindingUtilsKt.setLayoutConstraintGuidePercent(this.guidelineRight, androidxDatabindingViewDataBindingSafeUnboxViewModelRightAnchorGetValue);
        }
        if ((dirtyFlags & 0x1200L) != 0) {
            // api target 1
