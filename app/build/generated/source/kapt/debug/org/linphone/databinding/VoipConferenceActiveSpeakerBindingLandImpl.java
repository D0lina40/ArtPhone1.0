...
public class VoipConferenceActiveSpeakerBindingLandImpl extends VoipConferenceActiveSpeakerBinding implements org.linphone.generated.callback.OnClickListener.Listener {
    ...
    public VoipConferenceActiveSpeakerBindingLandImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 28, sIncludes, sViewsWithIds));
    }
    private VoipConferenceActiveSpeakerBindingLandImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 31
            , (android.widget.Chronometer) bindings[27]
            , (android.view.View) bindings[9]
            , (android.widget.ImageView) bindings[14]
            , (org.linphone.activities.voip.views.RoundCornersTextureView) bindings[13]
            ...
            , (org.linphone.activities.voip.views.ScrollDotsView) bindings[6]
        ...
        setRootTag(root);
        // listeners
        mCallback77 = new org.linphone.generated.callback.OnClickListener(this, 5);
        mCallback74 = new org.linphone.generated.callback.OnClickListener(this, 2);
        mCallback76 = new org.linphone.generated.callback.OnClickListener(this, 4);
        mCallback75 = new org.linphone.generated.callback.OnClickListener(this, 3);
        mCallback73 = new org.linphone.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        float controlsViewModelFullScreenModeLocalParticipantBackgroundAndroidDimenMargin0dpLocalParticipantBackgroundAndroidDimenVoipActiveSpeakerTopMargin = 0f;
        ...
        if ((dirtyFlags & 0x44000000000L) != 0 || (dirtyFlags_1 & 0x100048L) != 0) {
        ...
        if ((dirtyFlags & 0x20000000000000L) != 0 || (dirtyFlags_1 & 0x40100L) != 0) {
        ...
        if ((dirtyFlags & 0x80000000000000L) != 0 || (dirtyFlags_1 & 0x80000000000L) != 0) {
        ...
        if ((dirtyFlags_1 & 0x200200000L) != 0) {


            if ((dirtyFlags_1 & 0x200000000L) != 0) {
        ...
        if ((dirtyFlags & 0x600000020L) != 0) {
            ...
            org.linphone.utils.DataBindingUtilsKt.setConstraintLayoutTopMargin(this.localParticipantBackground, controlsViewModelFullScreenModeLocalParticipantBackgroundAndroidDimenMargin0dpLocalParticipantBackgroundAndroidDimenVoipActiveSpeakerTopMargin);
            org.linphone.utils.DataBindingUtilsKt.setConstraintLayoutEndMargin(this.scrollIndicator, controlsViewModelFullScreenModeScrollIndicatorAndroidDimenMargin0dpScrollIndicatorAndroidDimenVoipConferenceActiveSpeakerDotsMargin);
        }
        if ((dirtyFlags & 0x480000802L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x400000000L) != 0) {
            ...
            this.activeSpeakerBackground.setOnClickListener(mCallback75);
            org.linphone.utils.DataBindingUtilsKt.setInflatedViewStubLifecycleOwner(this.conferenceConstraintLayout, true);
            this.localParticipantBackground.setOnClickListener(mCallback76);
            org.linphone.utils.DataBindingUtilsKt.setSelectedIndex(this.scrollIndicator, 0);
            this.switchCamera.setOnClickListener(mCallback77);
            this.toggleConferenceRecording.setOnClickListener(mCallback74);
            this.togglePauseConference.setOnClickListener(mCallback73);
        }
        if ((dirtyFlags & 0x4a0010800L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x480010000L) != 0) {
            ...
            ((android.widget.ScrollView) this.miniatures).setVisibility(conferenceViewModelMoreThanTwoParticipantsViewVISIBLEViewGONE);
        }
        if ((dirtyFlags & 0x600000008L) != 0) {
            // api target 1
    ...
    /* flag mapping
        ...
        flag 73 (0x4aL): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.conferenceCreationPending.getValue()) ? true : !androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isConferenceLocallyPaused.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.meParticipant.getValue().isJoining.getValue())
        flag 74 (0x4bL): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.conferenceCreationPending.getValue()) ? true : !androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isConferenceLocallyPaused.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.meParticipant.getValue().isJoining.getValue())
        flag 75 (0x4cL): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.meParticipant.getValue().isInConference.getValue()) ? androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.isSendingVideo.getValue()) : false ? View.VISIBLE : View.GONE
        flag 76 (0x4dL): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.meParticipant.getValue().isInConference.getValue()) ? androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.isSendingVideo.getValue()) : false ? View.VISIBLE : View.GONE
        flag 77 (0x4eL): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.twoOrMoreParticipants.getValue()) ? @android:dimen/margin_0dp : @android:dimen/voip_active_speaker_top_margin
        flag 78 (0x4fL): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.twoOrMoreParticipants.getValue()) ? @android:dimen/margin_0dp : @android:dimen/voip_active_speaker_top_margin
        flag 79 (0x50L): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.conferenceCreationPending.getValue()) ? true : !androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isConferenceLocallyPaused.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.meParticipant.getValue().isJoining.getValue()) ? View.GONE : View.VISIBLE
        flag 80 (0x51L): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.conferenceCreationPending.getValue()) ? true : !androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isConferenceLocallyPaused.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.meParticipant.getValue().isJoining.getValue()) ? View.GONE : View.VISIBLE
        flag 81 (0x52L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.isSwitchCameraAvailable.getValue()) ? !androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue()) : false
        flag 82 (0x53L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.isSwitchCameraAvailable.getValue()) ? !androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue()) : false
        flag 83 (0x54L): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.speakingParticipant.getValue().isMuted.getValue()) ? !androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.moreThanTwoParticipants.getValue()) : false
        flag 84 (0x55L): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.speakingParticipant.getValue().isMuted.getValue()) ? !androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.moreThanTwoParticipants.getValue()) : false
        flag 85 (0x56L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.folded.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue()) ? @android:dimen/margin_0dp : androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isRemotelyRecorded.getValue()) ? @android:dimen/voip_single_call_header_size_with_record_info : @android:dimen/voip_single_call_header_size
        flag 86 (0x57L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.folded.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue()) ? @android:dimen/margin_0dp : androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isRemotelyRecorded.getValue()) ? @android:dimen/voip_single_call_header_size_with_record_info : @android:dimen/voip_single_call_header_size
        flag 87 (0x58L): !androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isConferenceLocallyPaused.getValue()) ? androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.speakingParticipantVideoEnabled.getValue()) : false
        flag 88 (0x59L): !androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isConferenceLocallyPaused.getValue()) ? androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.speakingParticipantVideoEnabled.getValue()) : false
        flag 89 (0x5aL): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.folded.getValue()) ? @android:dimen/voip_conference_header_folded_top_margin : @android:dimen/margin_0dp
        flag 90 (0x5bL): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.folded.getValue()) ? @android:dimen/voip_conference_header_folded_top_margin : @android:dimen/margin_0dp
        flag 91 (0x5cL): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.speakingParticipant.getValue().isJoining.getValue()) ? View.VISIBLE : View.GONE
        flag 92 (0x5dL): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.speakingParticipant.getValue().isJoining.getValue()) ? View.VISIBLE : View.GONE
        flag 93 (0x5eL): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue()) ? @android:dimen/margin_0dp : @android:dimen/voip_buttons_fragment_margin_size
        flag 94 (0x5fL): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue()) ? @android:dimen/margin_0dp : @android:dimen/voip_buttons_fragment_margin_size
        flag 95 (0x60L): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.meParticipant.getValue().isSpeaking.getValue()) ? View.VISIBLE : View.GONE
        flag 96 (0x61L): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.meParticipant.getValue().isSpeaking.getValue()) ? View.VISIBLE : View.GONE
        flag 97 (0x62L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue()) ? true : !androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.moreThanTwoParticipants.getValue())
        flag 98 (0x63L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue()) ? true : !androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.moreThanTwoParticipants.getValue())
        flag 99 (0x64L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? @android:dimen/margin_0dp : @android:dimen/voip_active_speaker_top_margin
        flag 100 (0x65L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? @android:dimen/margin_0dp : @android:dimen/voip_active_speaker_top_margin
        flag 101 (0x66L): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.speakingParticipantFound.getValue()) ? androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.speakingParticipant.getValue().isInConference.getValue()) : false ? View.GONE : View.VISIBLE
        flag 102 (0x67L): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.speakingParticipantFound.getValue()) ? androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.speakingParticipant.getValue().isInConference.getValue()) : false ? View.GONE : View.VISIBLE
        flag 103 (0x68L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue()) ? View.GONE : View.VISIBLE
        flag 104 (0x69L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue()) ? View.GONE : View.VISIBLE
        flag 105 (0x6aL): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isRemotelyRecorded.getValue()) ? @android:dimen/voip_single_call_header_size_with_record_info : @android:dimen/voip_single_call_header_size
        flag 106 (0x6bL): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isRemotelyRecorded.getValue()) ? @android:dimen/voip_single_call_header_size_with_record_info : @android:dimen/voip_single_call_header_size
        flag 107 (0x6cL): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.folded.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue())
        flag 108 (0x6dL): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.folded.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue())
        flag 109 (0x6eL): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isRemotelyRecorded.getValue()) ? View.VISIBLE : View.GONE
        flag 110 (0x6fL): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isRemotelyRecorded.getValue()) ? View.VISIBLE : View.GONE
        flag 111 (0x70L): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.moreThanTwoParticipants.getValue()) ? View.VISIBLE : View.GONE
        flag 112 (0x71L): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.moreThanTwoParticipants.getValue()) ? View.VISIBLE : View.GONE
    flag mapping end*/
    //end
}