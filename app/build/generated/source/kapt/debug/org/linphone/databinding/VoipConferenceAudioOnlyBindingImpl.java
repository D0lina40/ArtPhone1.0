...
public class VoipConferenceAudioOnlyBindingImpl extends VoipConferenceAudioOnlyBinding implements org.linphone.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.grid_scrollview, 11);
    }
    // views
    // variables
    @Nullable
    ...
    public VoipConferenceAudioOnlyBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private VoipConferenceAudioOnlyBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 10
            , (android.widget.Chronometer) bindings[10]
            , (androidx.constraintlayout.widget.ConstraintLayout) bindings[0]
            , (androidx.gridlayout.widget.GridLayout) bindings[6]
        ...
        setRootTag(root);
        // listeners
        mCallback121 = new org.linphone.generated.callback.OnClickListener(this, 1);
        mCallback122 = new org.linphone.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        float controlsViewModelFoldedTopBarrierAndroidDimenMargin0dpConferenceViewModelIsRemotelyRecordedTopBarrierAndroidDimenVoipSingleCallHeaderSizeWithRecordInfoTopBarrierAndroidDimenVoipSingleCallHeaderSize = 0f;
        ...
        if ((dirtyFlags & 0x3418L) != 0) {
                ...
                // read androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.folded.getValue()) ? @android:dimen/margin_0dp : androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isRemotelyRecorded.getValue()) ? @android:dimen/voip_single_call_header_size_with_record_info : @android:dimen/voip_single_call_header_size
                controlsViewModelFoldedTopBarrierAndroidDimenMargin0dpConferenceViewModelIsRemotelyRecordedTopBarrierAndroidDimenVoipSingleCallHeaderSizeWithRecordInfoTopBarrierAndroidDimenVoipSingleCallHeaderSize = ((androidxDatabindingViewDataBindingSafeUnboxControlsViewModelFoldedGetValue) ? (topBarrier.getResources().getDimension(R.dimen.margin_0dp)) : (conferenceViewModelIsRemotelyRecordedTopBarrierAndroidDimenVoipSingleCallHeaderSizeWithRecordInfoTopBarrierAndroidDimenVoipSingleCallHeaderSize));
        }
        if ((dirtyFlags & 0x3021L) != 0) {
        ...
        if ((dirtyFlags & 0x2000L) != 0) {
            ...
            this.toggleConferenceRecording.setOnClickListener(mCallback122);
            this.togglePauseConference.setOnClickListener(mCallback121);
        }
        if ((dirtyFlags & 0x2404L) != 0) {
            // api target 1

            org.linphone.utils.DataBindingUtilsKt.setEntries(this.gridLayout, conferenceViewModelConferenceParticipantDevicesGetValue, R.layout.voip_conference_participant_remote_audio_only);
        }
        if ((dirtyFlags & 0x3008L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x3418L) != 0) {
            ...
            org.linphone.utils.DataBindingUtilsKt.setConstraintLayoutTopMargin(this.topBarrier, controlsViewModelFoldedTopBarrierAndroidDimenMargin0dpConferenceViewModelIsRemotelyRecordedTopBarrierAndroidDimenVoipSingleCallHeaderSizeWithRecordInfoTopBarrierAndroidDimenVoipSingleCallHeaderSize);
        }
    ...
    /* flag mapping
        ...
        flag 13 (0xeL): null
        flag 14 (0xfL): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.folded.getValue()) ? @android:dimen/margin_0dp : androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isRemotelyRecorded.getValue()) ? @android:dimen/voip_single_call_header_size_with_record_info : @android:dimen/voip_single_call_header_size
        flag 15 (0x10L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.folded.getValue()) ? @android:dimen/margin_0dp : androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isRemotelyRecorded.getValue()) ? @android:dimen/voip_single_call_header_size_with_record_info : @android:dimen/voip_single_call_header_size
        flag 16 (0x11L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue()) ? @android:dimen/margin_0dp : @android:dimen/voip_remote_margin
        flag 17 (0x12L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue()) ? @android:dimen/margin_0dp : @android:dimen/voip_remote_margin
        ...
        flag 20 (0x15L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue()) ? View.GONE : View.VISIBLE
        flag 21 (0x16L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue()) ? View.GONE : View.VISIBLE
        flag 22 (0x17L): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isRemotelyRecorded.getValue()) ? @android:dimen/voip_single_call_header_size_with_record_info : @android:dimen/voip_single_call_header_size
        flag 23 (0x18L): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isRemotelyRecorded.getValue()) ? @android:dimen/voip_single_call_header_size_with_record_info : @android:dimen/voip_single_call_header_size
        flag 24 (0x19L): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.folded.getValue()) ? @android:dimen/voip_conference_header_folded_top_margin : @android:dimen/margin_0dp
        flag 25 (0x1aL): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.folded.getValue()) ? @android:dimen/voip_conference_header_folded_top_margin : @android:dimen/margin_0dp
        flag 26 (0x1bL): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isRemotelyRecorded.getValue()) ? View.VISIBLE : View.GONE
        flag 27 (0x1cL): androidx.databinding.ViewDataBinding.safeUnbox(conferenceViewModel.isRemotelyRecorded.getValue()) ? View.VISIBLE : View.GONE
        flag 28 (0x1dL): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue())
        flag 29 (0x1eL): androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.fullScreenMode.getValue()) ? true : androidx.databinding.ViewDataBinding.safeUnbox(controlsViewModel.pipMode.getValue())
    flag mapping end*/
    //end
}