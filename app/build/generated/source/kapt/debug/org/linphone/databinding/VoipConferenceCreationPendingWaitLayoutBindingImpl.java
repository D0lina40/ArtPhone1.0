...
public class VoipConferenceCreationPendingWaitLayoutBindingImpl extends VoipConferenceCreationPendingWaitLayoutBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.progress_text, 2);
    }
    // views
    // variables
    // values
    ...
    public VoipConferenceCreationPendingWaitLayoutBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private VoipConferenceCreationPendingWaitLayoutBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (android.widget.RelativeLayout) bindings[0]
            , (android.widget.ProgressBar) bindings[1]
            , (android.widget.TextView) bindings[2]
            );
        this.creationPendingLayout.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            this.creationPendingLayout.setVisibility(visibilityViewVISIBLEViewGONE);
        }
    }
